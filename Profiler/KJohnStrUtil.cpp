/** @file   KJohnStrUtil.cpp
    @desc   implementation of KJohnStrUtil
*/
...
*********************************************************************/
{
    ...
    while ( len > pos )
    {
             ...
             false == quoted )
        {
            ...
            {
                // if ch is a delimiter the token is complete
                token_complete = true;
             ...
             false == quoted )
        {
            ...
            {
                // if a delimiter is found the token is complete
                token_complete = true;
        ...
        if ( true == add_delimiter )
        {
            ...
            // if only a delimiter would be added, the new token isn't
            // complete. If the flag wouldn't be reset, the first char
            // would be a token.
            token_complete = false;
        }//if
