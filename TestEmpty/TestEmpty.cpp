...
INT WINAPI WinMain( HINSTANCE, HINSTANCE, LPSTR, int )
{
	...
	//CLucidashTest * pLucidashTest = new CLucidashTest();
...
HRESULT CALLBACK OnCreateDevice( IDirect3DDevice9* pd3dDevice, const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
	...
	CTestMain* pTestMain = new CTestMain();
	//CHoonTest* pHoonTest = new CHoonTest();
	
	//CLucidashTest* pLucidashTest = new CLucidashTest();

	//CHLSLTest* pCHLSLTest = new CHLSLTest();
	//CDialogTool* pDialogTool = new CDialogTool(); 
	//CHLSLTest* pCHLSLTest = new CHLSLTest();
	//CJooTest* pJooTest = new CJooTest();
	//CXFileCompare* pXFileCompare = new CXFileCompare();
	//CFCCompare* pXFileFrameSort = new CFCCompare();
	//CLineMapTool* pLineMapTool = new CLineMapTool();
	//CWorldTool* pWorldTool = new CWorldTool();
	
	//CItemViewer*	pTexViewer = new CItemViewer();
	//CTEXViewer*		pTexViewer = new CTEXViewer();
	//CTexUVOut*		pTexUVOut = new CTexUVOut();
	//pTexUVOut->GetDialog()->SetCallback( pTexViewer );
	//CNewDialogTool*	pNewDialogTool = new CNewDialogTool();
	//KX2DungeonTool*		pDungeonTool = new KX2DungeonTool();
	//CForfeitTest* pTestUI = new CForfeitTest();
	//CForfeitTest* pUiTest = new CForfeitTest();

	//CAITest* pAITest = new CAITest();

	//g_pKTDXApp->InsertStage( pNewDialogTool );	
	//g_pKTDXApp->InsertStage( pUiTest );
	//g_pKTDXApp->InsertStage(pTestUI);
	//g_pKTDXApp->InsertStage( pTexUVOut );
	//g_pKTDXApp->InsertStage( pAITest );
	//g_pKTDXApp->InsertStage( pJooTest );
	//g_pKTDXApp->InsertStage( pHoonTest );

	//g_pKTDXApp->InsertStage( pLucidashTest );
...
void RenderText()
{
	...
	txtHelper.Begin();
	txtHelper.SetInsertionPos( 10, 25 );
