...
public static class Base64
{
    ...
    public static byte[] Decode(string encoded)
    {
        ...
        // Match the legacy implementation: accept only the leading Base64 prefix and
        // stop at '=' or the first non-Base64 character instead of throwing.
        ...
        for (var sourceIndex = 0; sourceIndex < source.Length; sourceIndex += 4)
        {
            ...
            for (var i = 0; i < remaining; i++)
                quartet[i] = checked((byte)Alphabet.IndexOf(source[sourceIndex + i]));
