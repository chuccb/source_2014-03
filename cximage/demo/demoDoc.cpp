...
*/
	...
	//{{ 09-03-04.hoons.
	char charBuf[255] = {0,};
	WideCharToMultiByte( CP_ACP, 0, filename, -1, charBuf, 255, NULL, NULL );
	image = new CxImage(charBuf, type);
	//}} hoons edited
	Stopwatch(1);
...
BOOL CDemoDoc::OnSaveDocument(LPCTSTR lpszPathName) 
{
	...
	char charBuf[255] = {0,};
	WideCharToMultiByte( CP_ACP, 0, filename, -1, charBuf, 255, NULL, NULL );
	retval = image->Save(charBuf, type);
	//}} hoons edited
	Stopwatch(1);
	UpdateStatusBar();
