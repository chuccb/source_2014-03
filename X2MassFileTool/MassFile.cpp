...
{
	return m_MassFileHeader.bCompressed;
}
...
bool CMassFile::ModifyMassFile(CMassFile* pMassFile,char* strFileName, std::vector<char*> *pVecFile)
{
	FILE* file = fopen(strFileName, "w+b");
	if(file == NULL)
		return false;
...
bool CMassFile::ModifyMassFile( CMassFile* pMassFile, char* strFileName, std::vector<char*> *pVecFile, int iSubFileSize )
{
	//int 
	//while ( true )
	//{
