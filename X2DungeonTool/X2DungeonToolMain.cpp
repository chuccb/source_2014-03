...
#define DUNGEON_TOOL_VER	L"Dungeon Tool Ver. 20080418_A"
//--------------------------------------------------------------------------------------
// Global variables
//--------------------------------------------------------------------------------------
...
LPVOID					g_pCrashReportState;

// crashreport에서 쓰이는 콜백함수
BOOL WINAPI CrashReportCallbackDT(LPVOID lpvState)
{
...
INT WINAPI WinMain( HINSTANCE, HINSTANCE, LPSTR, int )
{
	...
	std::string strVer;
	ConvertWCHARToChar( strVer, DUNGEON_TOOL_VER );
	g_pCrashReportState = Install(CrashReportCallbackDT, (LPCTSTR)"sessakura@kogstudios.com", (LPCTSTR)strVer.c_str()); // crash report	
    ...
    DXUTCreateWindow( DUNGEON_TOOL_VER );
...
HRESULT CALLBACK OnCreateDevice( IDirect3DDevice9* pd3dDevice, const D3DSURFACE_DESC* pBackBufferSurfaceDesc, void* pUserContext )
{
	...
	g_pKTDXApp->InsertStage( pDungeonTool );
