...
bool ValidateRSA()
{
...

	{
		...
		FileSource keys(RELATIVE_DATA_FILE_PATH"rsa512a.dat", true, new HexDecoder);
	...
	{
		FileSource keys(RELATIVE_DATA_FILE_PATH"rsa1024.dat", true, new HexDecoder);
	...
	}
	{
		...
		FileSource privFile(RELATIVE_DATA_FILE_PATH"rsa400pv.dat", true, new HexDecoder);
		FileSource pubFile(RELATIVE_DATA_FILE_PATH"rsa400pb.dat", true, new HexDecoder);
...
bool ValidateDH()
{
	...
	FileSource f(RELATIVE_DATA_FILE_PATH"dh1024.dat", true, new HexDecoder());
	DH dh(f);
...
bool ValidateMQV()
{
	...
	FileSource f(RELATIVE_DATA_FILE_PATH"mqv1024.dat", true, new HexDecoder());
	MQV mqv(f);
...
bool ValidateLUC_DH()
{
	...
	FileSource f(RELATIVE_DATA_FILE_PATH"lucd512.dat", true, new HexDecoder());
	LUC_DH dh(f);
	return SimpleKeyAgreementValidate(dh);
}
...
bool ValidateXTR_DH()
{
	...
	FileSource f(RELATIVE_DATA_FILE_PATH"xtrdh171.dat", true, new HexDecoder());
	XTR_DH dh(f);
	return SimpleKeyAgreementValidate(dh);
}
...
bool ValidateElGamal()
{
	...
	bool pass = true;
	{
		FileSource fc(RELATIVE_DATA_FILE_PATH"elgc1024.dat", true, new HexDecoder);
...
bool ValidateDLIES()
{
	...
	bool pass = true;
	{
		FileSource fc(RELATIVE_DATA_FILE_PATH"dlie1024.dat", true, new HexDecoder);
...
bool ValidateNR()
{
	...
	bool pass = true;
	{
		FileSource f(RELATIVE_DATA_FILE_PATH"nr2048.dat", true, new HexDecoder);
...
bool ValidateDSA(bool thorough)
{
	...
	bool pass = true, fail;
	{
	FileSource fs(RELATIVE_DATA_FILE_PATH"dsa512.dat", true, new HexDecoder());
	...
	FileSource fs1(RELATIVE_DATA_FILE_PATH"dsa1024.dat", true, new HexDecoder());
	DSA::Signer priv(fs1);
	DSA::Verifier pub(priv);
	FileSource fs2(RELATIVE_DATA_FILE_PATH"dsa1024b.dat", true, new HexDecoder());
...
bool ValidateLUC()
{
	...
	{
		FileSource f(RELATIVE_DATA_FILE_PATH"luc1024.dat", true, new HexDecoder);
...
bool ValidateLUC_DL()
{
	...
	FileSource f(RELATIVE_DATA_FILE_PATH"lucs512.dat", true, new HexDecoder);
	...
	FileSource fc(RELATIVE_DATA_FILE_PATH"lucc512.dat", true, new HexDecoder);
...
bool ValidateRabin()
{
	...
	{
		FileSource f(RELATIVE_DATA_FILE_PATH"rabi1024.dat", true, new HexDecoder);
...
bool ValidateRW()
{
	...
	FileSource f(RELATIVE_DATA_FILE_PATH"rw1024.dat", true, new HexDecoder);
...
bool ValidateESIGN()
{
	...
	FileSource keys(RELATIVE_DATA_FILE_PATH"esig1536.dat", true, new HexDecoder);
