...
bool ValidateDES()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"descert.dat", true, new HexDecoder);
	bool pass = BlockTransformationTest(FixedRoundsCipherFactory<DESEncryption, DESDecryption>(), valdata);

	cout << "\nTesting EDE2, EDE3, and XEX3 variants...\n\n";

	FileSource valdata1(RELATIVE_DATA_FILE_PATH"3desval.dat", true, new HexDecoder);
...
bool ValidateIDEA()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"ideaval.dat", true, new HexDecoder);
...
bool ValidateSAFER()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"saferval.dat", true, new HexDecoder);
	bool pass = true;
...
bool ValidateRC2()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"rc2val.dat", true, new HexDecoder);
	HexEncoder output(new FileSink(cout));
...
bool ValidateRC5()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"rc5val.dat", true, new HexDecoder);
...
bool ValidateRC6()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"rc6val.dat", true, new HexDecoder);
	bool pass = true;
...
bool ValidateMARS()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"marsval.dat", true, new HexDecoder);
	bool pass = true;
...
bool ValidateRijndael()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"rijndael.dat", true, new HexDecoder);
	bool pass = true;
...
bool ValidateTwofish()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"twofishv.dat", true, new HexDecoder);
	bool pass = true;
...
bool ValidateSerpent()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"serpentv.dat", true, new HexDecoder);
	bool pass = true;
...
bool ValidateThreeWay()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"3wayval.dat", true, new HexDecoder);
...
bool ValidateGOST()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"gostval.dat", true, new HexDecoder);
...
#ifdef WORD64_AVAILABLE
	FileSource valdata(RELATIVE_DATA_FILE_PATH"sharkval.dat", true, new HexDecoder);
...
bool ValidateCAST()
{
	...
	FileSource val128(RELATIVE_DATA_FILE_PATH"cast128v.dat", true, new HexDecoder);
	...
	FileSource val256(RELATIVE_DATA_FILE_PATH"cast256v.dat", true, new HexDecoder);
...
bool ValidateSquare()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"squareva.dat", true, new HexDecoder);
...
bool ValidateSKIPJACK()
{
	...
	FileSource valdata(RELATIVE_DATA_FILE_PATH"skipjack.dat", true, new HexDecoder);
...
bool ValidateSHACAL2()
{
	...
	bool pass = true;
	FileSource valdata(RELATIVE_DATA_FILE_PATH"shacal2v.dat", true, new HexDecoder);
...
#ifdef WORD64_AVAILABLE
	bool pass = true;
	FileSource valdata(RELATIVE_DATA_FILE_PATH"camellia.dat", true, new HexDecoder);
