================================================================================
              MFC 라이브러리 : X2ItemTool 프로젝트 개요
================================================================================

응용 프로그램 마법사를 사용하여 X2ItemTool 응용 프로그램을 만듭니다. 이 응용 
프로그램에서는 기본적인 MFC 사용 밥법과 응용 프로그램 작성 방법을 설명합니다.

이 파일에는 X2ItemTool 응용 프로그램을 구성하는 각 파일에 대한 개요가 포함되어
있습니다.
...
X2ItemTool.h
    ...
    특정 헤더가 포함되며 CX2ItemToolApp 응용 프로그램 클래스가 선언됩니다.

X2ItemTool.cpp
    CX2ItemToolApp 응용 프로그램 클래스를 포함하는 주 응용 프로그램의 소스 파일입니다.
...
res\X2ItemTool.ico
    ...
    이 아이콘은 주 리소스 파일인 X2ItemTool.rc에 포함됩니다.
...
X2ItemToolDoc.h, X2ItemToolDoc.cpp - 문서
    CX2ItemToolDoc 클래스를 포함하는 파일입니다. 이 파일을 편집하여
    특정 문서 데이터를 추가하고 파일을 저장 및 로드합니다
    (CX2ItemToolDoc::Serialize 사용).
X2ItemToolView.h, X2ItemToolView.cpp - 문서 뷰
    CX2ItemToolView 클래스를 포함하는 파일입니다.
    CX2ItemToolView 개체를 사용하여 CX2ItemToolDoc 개체를 볼 수 있습니다.
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h, StdAfx.cpp
    미리 컴파일된 헤더 파일(PCH) X2ItemTool.pch 및 미리 컴파일된
