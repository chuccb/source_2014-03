...
SELECT TransIDX, CountryCode, DB, TableName, [Column], [Index], String, [Create Date], [Last Update Date] FROM Trans WHERE (TransIDX = SCOPE_IDENTITY())";
            ...
            this._commandCollection[3].CommandText = "UPDATE  Trans\r\nSET         String = @String\r\nWHERE   (TableName = N\'TextureString" +
                "Manager\') AND ([Index] = @Index) AND \r\n                (CountryCode = @CountryCo" +
                "de);   \r\n";
        ...
        public virtual int UpdateTextureStringManagerTable(string String, global::System.Nullable<int> Index, string CountryCode) {
