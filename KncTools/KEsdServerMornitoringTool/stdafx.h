...
// - - - - - - - - - - - - - - - - - - - - - - - - -
//#define COMPILE_CANT_CONTROL_SERVER
//#define COMPILE_CANT_HSB_UPDATE
//#define COMPILE_CANT_CONNECT_SERVER
//#define COMPILE_CANT_DATE_INFO
//#define COMPILE_NO_LOGIN
#define COMPILE_FOR_MAIN_SERVER
#define COMPILE_SHOW_GUEST_ID_CCU
...
#define BOOST_FORMAT( f ) boost::str( boost::wformat f );
