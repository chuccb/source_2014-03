...
{
	return CFileCrypt::FileDecrypt( vecEncryptionKey, pDecryptedBuffer, iBufferSize );
}

char* CFileCrypt::FileDecrypt( std::vector<int>& vecDecryptionKey, const char* pEncryptedBuffer, int iBufferSize )
{
	char pBuf[5];
