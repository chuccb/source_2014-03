...
BOOL CCrashRptTestApp::InitInstance()
{
   ...
   m_lpvState = Install(CrashCallback, "carl79@kogstudios.com", _T("버전이름_유저ID_캐릭터ID"));
   SetEMailSubjectPrefix( m_lpvState, "version_name" );
...
{
	//CCrashHandler* pCrash = (CCrashHandler*) m_lpvState;
	
	//pCrash->SetMailSubjectPrefix( "version_name_unit_name" );
