...
public:
	void SetSelected(BOOL bSelected) { m_bIsSelected = bSelected; }
	//void SetUseCustomDisable(BOOL bUseCustomDisable) { m_bUseCustomDisable = bUseCustomDisable; }
	...
	//DWORD SetPngs(const char* pBitmapIn, const char* pBitmapOut, const char* pBitmapPress);
	DWORD SetBitmaps(int nBitmapIn, COLORREF crTransColorIn, int nBitmapOut = NULL, COLORREF crTransColorOut = 0, int nBitmapPress = NULL, COLORREF crTransColorPress = 0, int nBitmapSelect = NULL, COLORREF crTransColorSelect = 0, int nBitmapCustomDisable = NULL, COLORREF crTransColorCustomDisable = 0);
	DWORD SetBitmaps(HBITMAP hBitmapIn, COLORREF crTransColorIn, HBITMAP hBitmapOut = NULL, COLORREF crTransColorOut = 0, HBITMAP hBitmapPress = NULL, COLORREF crTransColorPress = 0, HBITMAP hBitmapSelect = NULL, COLORREF crTransColorSelect = 0, HBITMAP hBitmapCustomDisable = NULL, COLORREF crTransColorCustomDisable = 0);
	...
	void SetFontType(int iFontHeight, int iFontCharSet, LPCTSTR lpszFontFace);
...
protected:
	...
	BOOL     m_bUseCustomDisable;
	BOOL		m_bIsDisabled;		// Is button disabled?
	BOOL		m_bIsSelected;
	BOOL		m_bIsCustomDisable;
...
private:
	...
	virtual void DrawTheBitmap(CDC* pDC, BOOL bHasTitle, RECT* rpItem, CRect* rpCaption, BOOL bIsPressed, BOOL bIsDisabled, BOOL bIsSelected, BOOL bIsCustomDisabled);
...
public:
	...
	//afx_msg void CButtonST::OnWindowPosChanged(WINDOWPOS* lpwndpos);

protected:

private:
	//int m_iPreBgX, m_iPreBgY;
	//CRect m_PreRect;
